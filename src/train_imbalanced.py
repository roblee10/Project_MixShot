...
def get_dataloader(split, aug=False, shuffle=True, out_name=False, sample=None, analyze=None, triplet = None, imbal_data = False, resample = None, multisample = None):
...
def my_collate(batch):
    sup_pipeline = aug_pipeline(84, clone_augment_method=args.clone_augment_method)
...
def meta_pointing_augmentation(train_dict, train_mean, train_samples, test_dict, shot, clone_factor, how_close_factor):
    ...
    episode_train = test_dict['support_idx_dict'] # 여기에 train 에피소드 인덱스들 0~9999(만개 이므로) 에 각 5shot 이면 25개, 1shot 이면 5개 담고
...
def pointing_augmentation_eval(model, log):
    ...
    if os.path.isfile(pkl_dict1) and os.path.isfile(pkl_dict2):
        metadict_1shot = load_pickle(pkl_dict1)
        metadict_5shot = load_pickle(pkl_dict2)
    else:
        ...
        save_pickle(pkl_dict1, metadict_1shot)
        save_pickle(pkl_dict2, metadict_5shot)
    
    # 얼마나 가깝게 할건지 

    factor_list = [0.9,0.7,0.5,0.3,0.1,0]
    # factor_list = [0.79,0,78,0.77,0.76,0.75,0.74,0.73,0.72,0.71,0.7,
...
# MiniImageNet
# Baseline
    # args.logname="baseline_rrc.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.clone_augment_method = 'randomresizedcrop'
    # main()

    # args.logname="baseline_rotation.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.clone_augment_method = 'rotation'
    # main()

    # args.logname="baseline_rrc+rotation.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.clone_augment_method = 'rrc+rotation'
    # main()

    # args.logname="baseline_none.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.clone_augment_method = 'none'
    # main()

# No Cloning
    # args.logname="Pointing_equalperclass_1.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = 'equal_per_class'
    # args.pointing_aug_equalperclass_num = 1
    # main()

    # args.logname="Pointing_equalperclass_10.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = 'equal_per_class'
    # args.pointing_aug_equalperclass_num = 10
    # main()

    # args.logname="Pointing_equalperclass_50.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = 'equal_per_class'
    # args.pointing_aug_equalperclass_num = 50
    # main()


    # args.logname="Pointing_randomgeneration_10.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = 'random_generation'
    # args.pointing_aug_randomgeneration_num = 10
    # main()

    # args.logname="Pointing_randomgeneration_100.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = 'random_generation'
    # args.pointing_aug_randomgeneration_num = 100
    # main()

    # args.logname="Pointing_randomgeneration_500.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = 'random_generation'
    # args.pointing_aug_randomgeneration_num = 500
    # main()

    # args.logname="Pointing_selectclass_10.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = "select_class"
    # args.pointing_aug_selectclass_num = 10
    # main()

    # args.logname="Pointing_selectclass_100.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = "select_class"
    # args.pointing_aug_selectclass_num = 100
    # main()

    # args.logname="Pointing_selectclass_500.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = "select_class"
    # args.pointing_aug_selectclass_num = 500
    # main()


# With Cloning

    # args.logname="Cloning_equalperclass_1.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.pointing_aug_sample_type = 'equal_per_class'
    ...
    # args.logname="Cloning_equalperclass_10.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.pointing_aug_sample_type = 'equal_per_class'
    ...
    # args.logname="Cloning_equalperclass_50.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.pointing_aug_sample_type = 'equal_per_class'
    ...
    # args.logname="Cloning_randomgeneration_10.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.pointing_aug_sample_type = 'random_generation'
    ...
    # args.logname="Cloning_randomgeneration_100.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.pointing_aug_sample_type = 'random_generation'
    ...
    # args.logname="Cloning_randomgeneration_500.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.pointing_aug_sample_type = 'random_generation'
    ...
    # args.logname="Cloning_selectclass_10.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.pointing_aug_sample_type = "select_class"
    ...
    # args.logname="Cloning_selectclass_100.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.pointing_aug_sample_type = "select_class"
    ...
    # args.logname="Cloning_selectclass_500.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.pointing_aug_sample_type = "select_class"
...
# Baseline
    ...
    # args.logname="baseline.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = 'none'
    # main()
...
# With Cloning
    ...
    # args.logname="Cloning_none_equalperclass_10.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.clone_augment_method = 'none'
    ...
    # args.logname="Cloning_none_randomgeneration_100.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.clone_augment_method = 'none'
    ...
    # args.logname="Cloning_none_selectclass_100.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.clone_augment_method = 'none'
    # args.pointing_aug_sample_type = "select_class"
    # args.pointing_aug_selectclass_num = 100
    # args.select_class_type = "random"
    # main()

    # args.logname="08_19_tiered_cloning_equalperclass_1.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.pointing_aug_sample_type = 'equal_per_class'
    ...
    # args.logname="08_19_tiered_cloning_equalperclass_10.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.pointing_aug_sample_type = 'equal_per_class'
    ...
    # args.logname="08_19_tiered_cloning_randomgeneration_10.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.pointing_aug_sample_type = 'random_generation'
    ...
    # args.logname="08_19_tiered_cloning_randomgeneration_600.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.pointing_aug_sample_type = 'random_generation'
    # args.pointing_aug_randomgeneration_num = 600
    # main()

    # args.logname="08_19_tiered_cloning_select_random_10.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.pointing_aug_sample_type = "select_class"
    ...
    # args.logname="08_19_tiered_cloning_select_random_600.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.pointing_aug_sample_type = "select_class"
    # args.pointing_aug_selectclass_num = 600
    # args.select_class_type = "random"
    # main()
...
# Without Cloning
    ...
    # args.logname="08_19_tiered_pointing_equalperclass_1.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = 'equal_per_class'
    ...
    # args.logname="08_19_tiered_pointing_equalperclass_10.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = 'equal_per_class'
    ...
    # args.logname="08_19_tiered_pointing_randomgeneration_10.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = 'random_generation'
    ...
    # args.logname="08_19_tiered_pointing_randomgeneration_600.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = 'random_generation'
    ...
    # args.logname="08_19_tiered_pointing_select_random_10.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = "select_class"
    ...
    # args.logname="08_19_tiered_pointing_select_random_600.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = "select_class"
    ...
    # args.logname="06_28_cloning_select_closest_50_CL2N.log"
    # args.pointing_aug_sample_type = "select_class"
    # args.pointing_aug_selectclass_num = 50
    # args.select_class_type = "close"
    # args.select_class_metric = "CL2N"
    # main()

    # args.logname="06_28_cloning_select_closest_50_L2N.log"
    # args.pointing_aug_sample_type = "select_class"
    # args.pointing_aug_selectclass_num = 50
    # args.select_class_type = "close"
    # args.select_class_metric = "L2N"
    # main()

    # args.logname="06_28_cloning_select_closest_50_UN.log"
    # args.pointing_aug_sample_type = "select_class"
    # args.pointing_aug_selectclass_num = 50
    # args.select_class_type = "close"
    # args.select_class_metric = "UN"
    # main()

    # args.logname="06_28_cloning_select_farthest_50_CL2N.log"
    # args.pointing_aug_sample_type = "select_class"
    # args.pointing_aug_selectclass_num = 50
    # args.select_class_type = "far"
    # args.select_class_metric = "CL2N"
    # main()

    # args.logname="06_28_cloning_select_farthest_50_L2N.log"
    # args.pointing_aug_sample_type = "select_class"
    # args.pointing_aug_selectclass_num = 50
    # args.select_class_type = "far"
    # args.select_class_metric = "L2N"
    ...
    # args.logname="06_28_cloning_select_farthest_50_UN.log"
    # args.pointing_aug_sample_type = "select_class"
    # args.pointing_aug_selectclass_num = 50
    # args.select_class_type = "far"
    # args.select_class_metric = "UN"
...
# No Cloning 상태에서 Random Sample 다시 해보기 
    # args.logname="06_29_pointing_randomgeneration_1.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = 'random_generation'
    # args.pointing_aug_randomgeneration_num = 1
    # main()

    # args.logname="06_29_pointing_randomgeneration_50.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = 'random_generation'
    # args.pointing_aug_randomgeneration_num = 50
    # main()

    # args.logname="06_29_pointing_randomgeneration_600.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = 'random_generation'
...
# No Cloning 상태에서 class select 다시 해보기

    # args.logname="06_29_pointing_select_random_1.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = "select_class"
    # args.pointing_aug_selectclass_num = 1
    # args.select_class_type = "random"
    # main()

    # args.logname="06_29_pointing_select_random_50.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = "select_class"
    ...
    # args.logname="06_29_pointing_select_random_600.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = "select_class"
    ...
    # Cloning : Yes
    # sample type : select 
    # select metric : random
    # sample 개수 : 600
    # how_close factor :  0.7
    # configuration : CL2N

    # args.logname="06_30_cloning_select_random_600.log"
    # args.meta_cloning = True
    # args.clone_factor_1shot = 20
    # args.clone_factor_5shot = 4
    # args.pointing_aug_sample_type = "select_class"
    ...
    # ACC : 0.7955(0.0014)
    # Cloning : No
    # sample type :  equal_per_class
    # sample 개수 : 클래스당 10개 (10 * 64)
    # how_close factor : 0.7
    # configuration : L2N

    # args.logname="06_30_pointing_equalperclass_10.log"
    # args.meta_cloning = False
    # args.clone_factor_1shot = 1
    # args.clone_factor_5shot = 1
    # args.pointing_aug_sample_type = "equal_per_class"
