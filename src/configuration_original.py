...
def parser_args():
    ...
    parser.add_argument('--no-meta-eval', action='store_true',
                        help='evalute with fully connected layer, not using meta evaluation')
    ...
    # Triplet train
    parser.add_argument('--triplet-batch',type = int, default = 100,
                        help = 'steps for each iteration')
    parser.add_argument('--triplet-iter',type = int, default = 10000,
    ...
    # 일단은 나머지 parameter는 anlz 사용하기

    parser.add_argument('--do-imbal-train', action='store_true',
                    help='imbalance train')
    parser.add_argument('--do-imbal-eval', action='store_true',
                    help='imbalance test')

    parser.add_argument('--imbal-iter', type=int, default=500,
                        help='number of iteration in evaluation')
    parser.add_argument('--imbal-way', type=int, default=5,
                        help='number of ways for imbalanced setting')
    parser.add_argument('--imbal-shot', type=int, default=5,
                        help='number of shots for imbalanced setting')
